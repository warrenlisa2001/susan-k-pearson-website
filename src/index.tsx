...
app.get('/', (c) => {
  return c.html(`
    ...
    <body class="smooth-scroll">
        ...
        <!-- Navigation -->
        <nav class="fixed w-full bg-cream backdrop-blur-sm shadow-lg z-50 border-b border-gold/40">
            ...
            <!-- Mobile Menu -->
            <div id="mobileMenu" class="hidden md:hidden bg-cream border-t border-gold/40">
