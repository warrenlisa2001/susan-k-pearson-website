                ...
                <div class="flex justify-between items-center h-32 md:h-36">
                    <div class="flex items-center">
                        <a href="#home" class="flex items-center py-3">
                            <img src="/images/skp-logo-final.png" alt="Susan K Pearson - Elemental Healing" class="h-20 md:h-24 w-auto transition-transform hover:scale-105" style="filter: invert(1) brightness(1.2);">
                        </a>
                    </div>
