  ...
  return c.html(`
    ...
    <head>
        ...
        <script type="application/ld+json">
        {
          ...
          "image": "https://susankpearson.com/images/skp-logo-gold.png",
                ...
                <div class="flex justify-between items-center h-32 md:h-36">
                    <div class="flex items-center">
                        <a href="#home" class="flex items-center py-3">
                            <img src="/images/skp-logo-gold.png" alt="Susan K Pearson - Elemental Healing" class="h-20 md:h-24 w-auto transition-transform hover:scale-105 drop-shadow-[0_0_20px_rgba(200,169,116,0.4)]">
                        </a>
                    </div>
